  ...
  useEffect(() => {
    ...
    (async () => {
      const response = await axios.get(
        `http://localhost/TravelMaker/Backend/public/api/albums/${token}`
      );
  ...
  return (
    <>
      ...
      <div className="container-fluid shadow p-0 bg-white" id="body-container">
        <div
          className="d-flex flex-nowrap row container-fluid m-0 p-0"
          id="content-container"
        >
          <Sidebar Album="active"></Sidebar>
          <div
            className="flex-fill px-0 justify-content-center"
            id="content"
              ...
              <div className="d-flex justify-content-between align-items-center mb-3">
                <div>
                  ...
                  <div className="dropdown mt-3 d-md-none">
                    ...
                    >
                      <li onClick={() => selectTag('全部')}>
                        <a className="dropdown-item" href="#">
                          全部
                        </a>
                      </li>
                      {Array.from(new Set(allAlbums.map(data => data.tag))).map((tag, index) => {
                        return (
                          <li key={index} onClick={() => selectTag(tag)}>
                            <a className="dropdown-item" href="#">
                              {tag}
                            </a>
                          </li>
                ...
                <div className="d-flex flex-column flex-md-row">
                  ...
                  <Link
                    className="btn btn-outline-primary ms-2 mb-2 mb-md-0"
                    to="/album/create"
                  >
                    建立新相簿
                  </Link>
                  ...
                  return (
                    <div className="col" key={data.album_id}>
                      <a
                        href="#"
                        className="albumLink"
                        onClick={() => openAlbumModal(data)}
                      >
                        <div
                          className="card m-2 album"
                          style={{
                            backgroundImage: `url(http://localhost/TravelMaker/Backend/public/storage/${data.photos[0].image_url})`,
                          }}
                        >
                          <div className="card-body albumBody">
                            <h4 className="card-title albumTitle fw-bold ps-3">
                              {data.album_name}
                            </h4>
                          </div>
                        </div>
      ...
      <div
        className="container-fluid bg-blue-1 shadow fixed-bottom d-flex d-sm-none align-items-center"
        style={{ height: '50px' }}
      >
        <div className="w-100">
          <ul
            className="d-flex rm-ul-style justify-content-around"
