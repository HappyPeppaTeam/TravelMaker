...
const DiscussionBoard = () => {
  ...
  return (
      <div className="discussion-board bg-blue-3 my-0">
        <div className="row row-cols-2 row-cols-md-5 g-1">
          <div className="sub-discussion-board-home col">
              <button className="btn btn-secondary" type="button" id="defaultDropdown">
                <Link to="/forum">首頁</Link>
              </button>
          </div>
          <div className="sub-discussion-board col" ref={dropdownRefs['北部討論版']}>
            <button
          ...
          <div className="sub-discussion-board col" ref={dropdownRefs['中部討論版']}>
            <button
          ...
          <div className="sub-discussion-board col" ref={dropdownRefs['南部討論版']}>
            <button
          ...
          <div className="sub-discussion-board col" ref={dropdownRefs['花東離島討論版']}>
            <button
