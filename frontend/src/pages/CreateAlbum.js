          ...
          >
            <div className="wrap m-5">
              ...
              <form action="" id="albumForm" className="tab mt-4 d-block">
                <div className="mb-3">
                  <label htmlFor="albumName" className="form-label fs-4">
                    相簿名稱
                  </label>
                  <input
                    type="text"
                    ...
                    placeholder="如 : 金瓜石兩日遊"
                    value={albumName}
                    onChange={(e) => setAlbumName(e.target.value)}
                  />
                </div>
                <div className="mb-3">
                  <label htmlFor="tag" className="form-label fs-4">
                    分類
                  </label>
                  <input
                    type="text"
                      ...
                      <div className="col" key={index}>
                        ...
                        <div className="imgInfo">
                          <div className="fileName w-100 d-flex justify-content-between align-items-center">
                            <p className="m-0 py-2 ps-2 text-white text-center">
                              {image.name}
                            </p>
                            <button
