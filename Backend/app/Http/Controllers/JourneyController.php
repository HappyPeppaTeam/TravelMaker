...
class JourneyController extends Controller
{
    ...
    function addNewJourney(Request $request)
    {
        try {
            ...
            if ($isInsert) {
                return response("Add new journey: {$journeyName} successful.", 201);
            } else {
    ...
    function deleteJourney(Request $request)
    {
        try {
            ...
            if ($rowsDeleted > 0) {
                return response("Delete {$journeyId} successful. Event handling: {$delEventRes}");
            } else {
    ...
    function updateJourney(Request $request)
    {
        try {
            ...
            if ($isUpdate) {
                return response("Update journey ID:{$journeyId} Name:{$journeyName} successful");
            }
            else {
