...
function JourneyThumbnail({handleOpenModal, handleOpenDropdown}) {
        ...
        <div
            ...
            <div className="rounded shadow"
                ...
                <div className="overlay rounded d-flex justify-content-center align-items-center position-relative">
                    ...
                    <div className="more-detail position-absolute top-0 end-0 p-1 m-3 rounded" style={moreDetailStyle} onClick={handleOpenDropdown} 
                        >
                        <i
