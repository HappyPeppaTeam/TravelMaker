            ...
            >
              ...
              >
                ...
                <div className="Article-information-main-footer-right">
                  ...
                  <label className="btn" htmlFor="floor">留言</label>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  <form action="">
                    <input className="Article-information-footer-messageboard-text" type="text" name="" id="floor" />
                    <input className="Article-information-footer-messageboard-submit btn btn-primary" type="submit"></input>
                  </form>
                </div>
              </div>
            </div>
